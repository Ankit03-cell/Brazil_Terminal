...
try:
    from config import LIVE_WORKBOOK_NAME, LIVE_WORKBOOK_SHEET_INDEX, LIVE_POLL_INTERVAL_SECONDS
except Exception:
    LIVE_WORKBOOK_NAME = "Live_Brazil_Terminal.xlsm"
    LIVE_WORKBOOK_SHEET_INDEX = 2
    LIVE_POLL_INTERVAL_SECONDS = 5.0
...
class LiveMonitorService:
    ...
    def __init__(
        self,
        workbook_name: str = LIVE_WORKBOOK_NAME,
        sheet_index: int = LIVE_WORKBOOK_SHEET_INDEX,
        poll_interval_seconds: float = LIVE_POLL_INTERVAL_SECONDS,
        max_rows: int = 250,
    ) -> None:
